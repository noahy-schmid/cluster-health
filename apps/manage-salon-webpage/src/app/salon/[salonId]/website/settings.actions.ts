  ...
  return Effect.runPromise(
    Effect.gen(function* () {
      ...
      return {
        ...
        faviconMediaId: Option.getOrElse(settings.favicon, () => ""),
      };
    }).pipe(
      Effect.catchTags({
 ...
 * @param faviconMediaId - Optional media ID of the favicon image
  ...
  return Effect.runPromise(
    Effect.gen(function* () {
      ...
      yield* service.updateWebsiteSettings(websiteId as WebsiteId, {
        slug,
        title,
        favicon: faviconMediaId ? Option.some(faviconMediaId) : Option.none(),
      });
